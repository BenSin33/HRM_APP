...
public class AccountActionRenderer extends JPanel implements TableCellRenderer {
    ...
    public AccountActionRenderer() {
        ...
        lockBtn = createButton(new FlatSVGIcon("icons/delete_button.svg", ICON_SIZE, ICON_SIZE), "Khóa/Mở khóa");
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
        ...
        if (isHovered) {
            ...
            lockBtn.setForeground(new Color(229, 57, 53).brighter());
        } else {
            editBtn.setForeground(new Color(66, 133, 244));
            lockBtn.setForeground(new Color(229, 57, 53));
        }
